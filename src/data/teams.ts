...
export const TEAMS: Team[] = [
  ...
  },
  {
    ...
    shortName: 'Guanacasteca',
    code: 'ADG',
    primaryColor: '#128038',
    secondaryColor: '#e31b23',
    accentColor: '#f7b928',
    stadium: 'Estadio Chorotega',
    city: 'Nicoya, Guanacaste',
    founded: 1973,
    titles: 0,
    starPlayers: ['Starling Matarrita', 'Johan Venegas', 'Josimar Olivero', 'Jemark Hernández', 'Antonny Monreal'],
    logoType: 'guanacasteca',
    logoUrl: '/logos/adg.svg',
  },
  {
    id: 'lib',
    ...
    secondaryColor: '#111111',
    accentColor: '#f59e0b',
    stadium: 'Estadio Edgardo Baltodano Briceño',
    city: 'Liberia, Guanacaste',
    founded: 1977,
    titles: 1,
    starPlayers: ['Daniel Colindres', 'Marvin Angulo', 'Jurguens Montenegro', 'Ignacio Gómez', 'Daniel Villegas'],
    logoType: 'liberia',
    logoUrl: '/logos/lib.svg',
  },
];
